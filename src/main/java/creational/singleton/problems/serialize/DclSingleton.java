package creational.singleton.problems.serialize;
...
public class DclSingleton implements Serializable {
    ...
    public static void main(String[] args) throws IllegalAccessException, NoSuchMethodException, IOException, ClassNotFoundException, FileNotFoundException {
        // 获取单例并序列化
